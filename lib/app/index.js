...
var DApplication = /** @class */ (function (_super) {
    ...
    Object.defineProperty(DApplication.prototype, "models", {
        get: function () {
            return factory_1.RemoteModelFactory
                .getInstance(this, this.services[exports.BACKGROUND_REMOTE]);
        },
        enumerable: false,
        configurable: true
    });
     ...
     * @override
     */
    DApplication.prototype.spawn = function (t) {
        var addr = _super.prototype.spawn.call(this, t);
