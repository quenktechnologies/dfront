...
exports.DScene = exports.BACKGROUND_REMOTE = void 0;
...
var DScene = /** @class */ (function (_super) {
    ...
    function DScene(resume, app) {
        ...
        _this.models = factory_1.RemoteModelFactory.getInstance(function (t) { return _this.spawn(t); }, _this.app.getAddressFor(exports.BACKGROUND_REMOTE));
        return _this;
    }
    /**
